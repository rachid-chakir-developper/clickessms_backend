...
NOTIF_TYPES_ALL = {
	...
	"EMPLOYEE_ABSENCE_NOT_JUSTIFIED": "EMPLOYEE_ABSENCE_NOT_JUSTIFIED",
	"EMPLOYEE_ABSENCE_TO_JUSTIFY": "EMPLOYEE_ABSENCE_TO_JUSTIFY",
	"EMPLOYEE_ABSENCE_JUSTIFIED": "EMPLOYEE_ABSENCE_JUSTIFIED",
...
class Notification(models.Model):
	NOTIF_TYPES = [
	    ...
	    ("EMPLOYEE_ABSENCE_NOT_JUSTIFIED", "Absence non justifiée"),
	    ("EMPLOYEE_ABSENCE_TO_JUSTIFY", "Justification d'absence requise"),
	    ("EMPLOYEE_ABSENCE_JUSTIFIED", "Absence justifiée"),
