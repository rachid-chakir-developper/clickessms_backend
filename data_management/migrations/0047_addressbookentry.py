    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beneficiary', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='address_book_entries', to='human_ressources.beneficiary')),
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='address_book_entries', to='companies.company')),
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='former_address_book_entries', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
