...
class BankAccount(models.Model):
	...
	number = models.CharField(max_length=255, editable=False, null=True)
	name = models.CharField(max_length=255, null=True)
	image = models.ForeignKey('medias.File', on_delete=models.SET_NULL, related_name='bank_account_image', null=True)
	account_number = models.CharField(max_length=255, null=True)
	account_type = models.CharField(max_length=50, choices=ACCOUNT_TYPES, default= "CURRENT")
