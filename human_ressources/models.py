...
class BeneficiaryAdmissionDocument(models.Model):
	beneficiary = models.ForeignKey(Beneficiary, on_delete=models.CASCADE, null=True, related_name='beneficiary_admission_documents')
...
class BeneficiaryStatusEntry(models.Model):
	beneficiary = models.ForeignKey(Beneficiary, on_delete=models.CASCADE, null=True, related_name='beneficiary_status_entries')
...
class BeneficiaryEndowmentEntry(models.Model):
	beneficiary = models.ForeignKey(Beneficiary, on_delete=models.CASCADE, null=True, related_name='beneficiary_endowment_entries')
...
class BeneficiaryEntry(models.Model):
	beneficiary = models.ForeignKey(Beneficiary, on_delete=models.CASCADE, null=True, related_name='beneficiary_entries')
...
class CareerEntry(models.Model):
	...
	number = models.CharField(max_length=255, editable=False, null=True)
	beneficiary = models.ForeignKey('human_ressources.Beneficiary', on_delete=models.CASCADE, related_name='career_entries', null=True)
